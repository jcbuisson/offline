<template>
   <v-responsive>
      <v-app>
         <v-app-bar title="Offline-first, real-time app with relational database">
            <div style="display: flex; gap: 10px;">
               <v-btn size="small" @click="clear">{{ isConnected ? 'déconnexion' : 'reconnexion' }}</v-btn>
               <OnlineStatus :isOnline="isConnected"></OnlineStatus>
